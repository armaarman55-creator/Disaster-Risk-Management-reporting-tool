...
const CORE_SECTIONS = [
  {
    ...
    blocks: [
      text('This contingency plan is prepared in terms of Section 53 of the Disaster Management Act, No. 57 of 2002 (as amended by Act 16 of 2015), which requires each municipality to prepare a disaster management plan for its area according to prevailing circumstances. The plan must form an integral part of the municipality\'s Integrated Development Plan (IDP) in terms of s.26(g) of the Local Government: Municipal Systems Act, No. 32 of 2000.'),
      text('This plan gives effect to the National Disaster Management Framework (NDMF), 2005 and must be read in conjunction with the municipality\'s Disaster Management Framework, Risk Assessment, and applicable Provincial Disaster Management Framework. A copy must be submitted to the National Disaster Management Centre (NDMC) and the applicable Provincial Disaster Management Centre (PDMC) upon adoption and following any significant amendment. The plan is reviewed annually or following a significant disaster event, in terms of s.48 of the Act.'),
      list([
