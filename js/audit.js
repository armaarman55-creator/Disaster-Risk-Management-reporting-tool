...
function bindRegister() {
  document.getElementById('btn-register')?.addEventListener('click', async () => {
    ...
    const role      = 'disaster_officer'; // Always registers as DRMO — other roles invited via Admin panel
    ...
    document.getElementById('panel-register').innerHTML = `
      <div style="text-align:center;padding:20px 0">
        ...
        <div style="font-size:13px;color:var(--text3);line-height:1.7;margin-bottom:20px">
          ${isActive
            ? 'You have been automatically activated as Disaster Risk Management Official for your municipality.<br>You can sign in now.'
            : 'Your registration is pending. You will receive an email when your account is activated.'
          }
        </div>
